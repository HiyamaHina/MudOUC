...
void Game::runShop() {
    std::vector<Item> goods = {
        ...
        Item("传奇盲盒","campus","有概率开出隐藏奖励：2500元 呢！",300,1,1,1),
        Item("神话盲盒","campus","有概率开出隐藏奖励：750元 呢！",100,1,1,1),
        Item("史诗盲盒","campus","有概率开出隐藏奖励：500元 呢！",75,1,1,1),
        Item("稀有盲盒","campus","有概率开出隐藏奖励：300元 呢！",50,1,1,1),
        Item("普通盲盒","campus","有概率开出隐藏奖励：50元 呢！",10,1,1,1)
    };
